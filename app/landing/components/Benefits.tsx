...
import { CardCornerAccents, Eyebrow, SectionSpacer, SectionCornerBrackets, CrosshairCorners } from '@/components/ui/primitives';
...
function BenefitCard({ title, desc, iconPath }: BenefitCardProps) {
  return (
    <div className="relative border border-white/12 bg-surface-card w-full flex flex-col justify-between p-6 min-h-[240px]">
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-col gap-2">
          {/* Title */}
          <div>
            <h4 className="text-[18px] md:text-[20px] font-normal tracking-tight text-foreground leading-snug">
              {title}
            </h4>
          </div>
          {/* Subtitle */}
...
export default function Benefits() {
  return (
    <section className="w-full flex flex-col items-center bg-background" id="benefits">
      <div className="w-full max-w-[1200px] border-x border-white/12 relative group">
        ...
        <div className="px-6 md:px-[48px] py-[80px] flex flex-col gap-[20px]">
          ...
          <h2 className="text-[clamp(32px,5vw,56px)] font-normal tracking-[-0.05em] leading-[1.05] text-foreground max-w-3xl">
